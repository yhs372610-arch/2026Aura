// 다국어 번역 데이터 - 원문 100% 복구 및 다국어 풍성한 버전
const translations = {
    en: {
        meta: {
    ...
    ja: {
        ...
        questions: [
            ...
            { q: "2026年が終わるとき、どんな気分でいたいですか？", a: ["大きな成果を成し遂げた達成感", "多くの愛を分か치合った充足感", "毎瞬間が生きていると感じた満足感", "平和で知恵に満ちた平穏"] },
        ...
        colors: {
            ...
            vampPurple: { name: "バンプパープル", subtitle: "神秘的な創造者", keywords: ["神秘的", "創造적", "強烈"], description: "あなたのオーラは、魅惑的で神秘的なエネルギーを秘めています. 暗闇の中に美しさを見出し、複雑さの中に深みを見つけます. あなたの創造的な強烈さは、他者をあなた独自のユニークな世界へと引き込みます.", strengths: ["深い創造的なビジョンと芸術的才能", "複雑な状況における柔軟性", "他者の好奇心を刺激する魅力的な存在感"], recommendations: ["あなた独自のユニークな創造的スタイル", "自分の芸術を堂々と世界に発信", "劇的な美学を探索"] },
            solarGold: { name: "ソーラーゴールド", subtitle: "輝くリーダー", keywords: ["活発", "インスピレーション", "自信"], description: "あなたのオーラは太陽のように輝き、周囲のすべてを明るく照らします. あなたの伝染性のあるエネルギーと楽観主義は、あなたをどこでも温かさを届ける生まれながらのリーダーにします.", strengths: ["生まれ持ったカリスマ性とリーダーシップ", "他者にエネルギーを与え動機付ける", "ダイナミックな環境で能力を発揮"], recommendations: ["2026年にはリーダー的な役割", "講演や発表を通じて情熱を共有", "エネルギー를 대담한 새로운 모험에"] },
    ...
    es: {
        ...
        questions: [
            ...
            { q: "¿Cuál es tu fin de semana ideal en 2026?", a: ["Planear un proyecto personal", "Pasar tiempo de calidad con seres queridos", "Explorar nuevas experiencias", "Leer, reflexionar y descansar"] },
    ...
    pt: {
        ...
        colors: {
            ...
            solarGold: { name: "Ouro Solar", subtitle: "Líder Radiante", keywords: ["Luz", "Brillo", "Ação"], description: "Sua aura brilha como o sol, iluminando tudo com otimismo. É um líder natural.", strengths: ["Carisma natural", "Motiva outros", "Prospera em ambientes dinâmicos"], recommendations: ["Assuma liderança", "Partilhe entusiasmo", "Novas aventuras"] },
...
function updatePageLanguage() {
    const lang = window.currentLanguage; const data = translations[lang] || translations['ko'];
...
function t(key) {
    const keys = key.split('.'); let val = translations[window.currentLanguage] || translations['ko'];
