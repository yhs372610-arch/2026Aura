...
const translations = {
    ...
    ko: {
        ...
        colors: {
            ...
            softRose: { name: "소프트 로즈", subtitle: "자비로운 치유자", keywords: ["공감력", "돌봄", "사랑"], description: "당신의 아우라는 부드럽고 치유하는 에너지로 빛납니다. 깊은 공감의 희귀한 재능을 가지고 있어, 다른 이들이 진정으로 보이고 돌봄 받는다고 느끼게 합니다. 당신의 존재 자체가 치유의 형태입니다.", strengths: ["상대방의 감정을 읽고 이해하는 능력이 매우 높습니다", "타인을 따뜻하게 위로하고 치유하는 천부적인 능력이 있습니다", "사람들이 안심하고 속마음을 털어놓을 공간을 만듭니다"], recommendations: ["봉사 활동이나 사람을 돕는 일에 참여해 보세요", "타인을 돌보면서도 자신만의 건강한 경계를 세우세요", "나 자신을 위한 자기관리를 소홀히 하지 마세요"] },
