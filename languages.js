...
const translations = {
    ...
    ko: {
        ...
        questions: [
            { q: "2026년 아침, 하루를 시작할 때 가장 먼저 드는 생각은?", a: ["오늘은 어떤 목표를 달성할까?", "평화롭고 차분한 하루이길", "오늘은 뭔가 신나는 일이 있을 것 같아!", "혼자만의 시간이 필요해"] },
            { q: "스트레스를 받을 때 당신은?", a: ["문제를 논리적으로 분석한다", "가까운 사람들과 대화한다", "창작 활동에 몰입한다", "혼자만의 시간이 필요하다"] },
            { q: "2026년 이상적인 주말은?", a: ["개인 프로젝트를 계획하고 실행", "사랑하는 사람들과 시간 보내기", "새로운 경험과 모험 탐험", "독서, 사색, 그리고 휴식"] },
            { q: "결정을 내릴 때 가장 중요한 것은?", a: ["논리와 실질적인 결과", "다른 사람의 감정에 미치는 영향", "직관과 열정 따르기", "깊은 성찰과 지혜"] },
            { q: "당신의 에너지 레벨은 보통?", a: ["안정적이고 집중적", "따뜻하고 배려심 있는", "높고 열정적인", "조용하고 사색적인"] },
            { q: "사회적 상황에서 당신은?", a: ["관찰하고 전략적으로 기여", "모두와 감정적으로 연결", "분위기 메이커", "소수와 깊은 대화 선호"] },
            { q: "당신에게 가장 큰 동기부여는?", a: ["명확하고 측정 가능한 목표 달성", "다른 사람 돕고 변화 만들기", "창의적 표현과 혁신", "더 깊은 진리 이해하기"] },
            { q: "도전에 대한 당신의 접근 방식은?", a: ["전략적 계획 수립", "주변 사람들의 지원 구하기", "열정적으로 뛰어들기", "근본 원인 파악에 시간 투자"] },
            { q: "사람들이 당신을 묘사할 때 자주 하는 말은?", a: ["믿을 수 있고 체계적", "배려심 있고 공감력 높음", "에너지 넘치고 영감을 줌", "지혜롭고 내성적"] },
            { q: "이상적인 업무 환경은?", a: ["명확한 목표가 있는 구조화된 환경", "협력적이고 서로 지원하는 환경", "역동적이고 빠른 속도", "조용하고 집중 가능한 환경"] },
            { q: "변화를 마주할 때, 당신은?", a: ["신중한 계획으로 적응", "다른 사람들은 어떻게 대처하는지 확인", "흥분하며 받아들임", "더 깊은 의미 성찰"] },
            { q: "당신의 창의적 표현 방식은?", a: ["문제 해결과 전략", "사람들과 연결하고 돕기", "예술, 음악, 또는 공연", "글쓰기, 철학, 또는 명상"] },
            { q: "2026년 말, 당신이 느끼고 싶은 감정은?", a: ["성취감과 성공", "사랑받고 연결됨", "살아있고 충만함", "평화롭고 현명함"] },
            { q: "자연과의 관계는?", a: ["질서와 패턴을 감상", "가장 연결감을 느끼는 곳", "활력과 영감을 줌", "성찰에 필수적"] },
            { q: "누군가 도움이 필요할 때, 당신은?", a: ["실용적인 해결책 제시", "감정적 지원 제공", "낙관과 에너지 가져옴", "지혜와 관점 공유"] }
        ],
        loading: {
            analyzing: "아우라 분석 중...",
            step1: "에너지 패턴 추출 중...",
        ...
        colors: {
            coolBlue: { name: "쿨 블루", subtitle: "차분한 전략가", keywords: ["전략적", "차분함", "신뢰감"], description: "당신의 아우라는 차분하고 침착한 에너지를 발산합니다. 논리와 명확함으로 삶에 접근하여 자연스러운 문제 해결사입니다. 2026년, 당신의 안정적인 존재감이 가장 큰 강점이 될 것입니다.", strengths: ["전략적 계획과 분석에 뛰어남", "압박 속에서도 침착함 유지", "혼돈에서 질서를 창조"], recommendations: ["신중한 계획이 필요한 프로젝트 주도", "글쓰기나 교육을 통해 통찰력 공유", "논리와 창의적 탐구의 균형"] },
            vampPurple: { name: "뱀프 퍼플", subtitle: "신비로운 창작자", keywords: ["신비로운", "창의적", "강렬한"], description: "당신의 아우라는 매혹적이고 신비로운 에너지를 담고 있습니다. 어둠 속에서 아름다움을, 복잡함 속에서 깊이를 봅니다. 당신의 창의적 강렬함은 다른 이들을 독특한 세계로 끌어들입니다.", strengths: ["깊은 창의적 비전과 예술적 재능", "복잡함과 뉘앙스에 편안함", "어둠을 아름다움으로 변형"], recommendations: ["독특한 창의적 스타일 포용", "과감하게 예술 세계와 공유", "드라마틱한 미학 탐구"] },
            solarGold: { name: "솔라 골드", subtitle: "빛나는 리더", keywords: ["활력적", "영감주는", "자신감"], description: "당신의 아우라는 태양처럼 빛나며 주변 모든 것을 밝힙니다. 전염성 있는 에너지와 낙관주의로 어디를 가든 따뜻함을 가져오는 타고난 리더입니다.", strengths: ["타고난 카리스마와 리더십 능력", "다른 이들에게 활력과 동기 부여", "역동적인 환경에서 번성"], recommendations: ["2026년 리더십 역할 맡기", "대중 연설을 통해 열정 공유", "에너지를 대담한 새 벤처에 집중"] },
            forestGreen: { name: "포레스트 그린", subtitle: "균형잡힌 조화자", keywords: ["균형잡힌", "안정적", "평화로운"], description: "당신의 아우라는 자연스럽고 조화로운 에너지로 흐릅니다. 숲처럼, 당신은 피난처와 균형을 제공합니다. 진정한 힘은 평형과 자연과의 연결에서 온다는 것을 이해합니다.", strengths: ["조화와 균형 창조에 탁월", "안정적이고 든든한 존재감", "자연과 리듬에 깊이 연결"], recommendations: ["2026년 균형잡힌 루틴 만들기", "정기적으로 자연에서 시간 보내기", "다른 이들이 중심 찾도록 돕기"] },
            softRose: { name: "소프트 로즈", subtitle: "자비로운 치유자", keywords: ["공감력", "돌봄", "사랑"], description: "당신의 아우라는 부드럽고 치유하는 에너지로 빛납니다. 깊은 공감의 희귀한 재능을 가지고 있어, 다른 이들이 진정으로 보이고 돌봄 받는다고 느끼게 합니다. 당신의 존재 자체가 치유의 형태입니다.", strengths: ["깊은 감성 지능과 공감 능력", "위로하고 치유하는 타고난 능력", "취약함을 위한 안전한 공간 창조"], recommendations: ["도움 직업이나 자원봉사 추구", "다른 이 돌보면서도 건강한 경계 설정", "진지하게 자기관리 실천"] },
            midnightBlack: { name: "미드나잇 블랙", subtitle: "깊은 철학자", keywords: ["내성적", "지혜로운", "심오한"], description: "당신의 아우라는 자정의 깊이를 담고 있으며, 그곳에서 가장 위대한 통찰이 나옵니다. 표면 너머의 의미를 추구하고, 관조적 본성은 다른 이들이 놓치는 진실을 드러냅니다.", strengths: ["심오한 철학적이고 분석적 사고", "다른 이들이 놓치는 연결을 봄", "깊은 성찰에서 나오는 지혜"], recommendations: ["글쓰기나 교육을 통해 통찰력 공유", "고독과 깊은 사고를 위한 시간 만들기", "철학, 심리학 또는 영성 탐구"] }
        },
    ...
    ja: {
        ...
        questions: [
            ...
            { q: "2026年の理想的な週末は？", a: ["個人プロジェクトを計画し実行", "愛する人たちと過ごす", "新しい体験と冒険を探索", "読書、瞑想、 그리고 휴식"] },
            ...
            { q: "人々があなたを表現するとき、よく言われるのは？", a: ["信頼できて組織的", "思いやりがあり共感力が高い", "エネルギッシュでインスピレーションを与える", "賢明で内省적"] },
            ...
            { q: "あなたの創造的表現方法は？", a: ["問題解決と戦略", "人々とつながり助ける", "芸術、音楽、またはパフォーマンス", "執筆, 哲学、または瞑想"] },
        ...
        colors: {
            coolBlue: { name: "クールブルー", subtitle: "冷静なストラテジスト", keywords: ["戦略的", "冷静", "信頼"], description: "あなたのオーラは冷静で落ち着いたエネルギーを放っています。論理と明晰さで人生に取り組み、自然な問題解決者です。2026年、あなたの安定した存在感が最大の強みになります。", strengths: ["戦略적計画と分析に優れる", "プレッシャー下でも冷静さを保つ", "混沌から秩序を創造"], recommendations: ["慎重な計画が必要なプロジェクトをリード", "執筆や教育を通じて洞察を共有", "論理と創造的探求のバランス"] },
            vampPurple: { name: "ヴァンプパープル", subtitle: "神秘的なクリエイター", keywords: ["神秘的", "創造的", "強烈"], description: "あなたのオーラは魅惑的で神秘的なエネルギーを持っています。暗闇の中に美を、複雑さの中に深さを見出します。あなたの創造的な強烈さは、他者をあなたの独特な世界に引き込みます。", strengths: ["深い創造的ビジョンと芸術的才能", "複雑さとニュアンスに快適", "暗闇を美に変換"], recommendations: ["独自の創造的スタイルを受け入れる", "大胆に芸術を世界と共有", "ドラマチックな美学を探求"] },
            ...
            softRose: { name: "ソフトローズ", subtitle: "慈悲深いヒーラー", keywords: ["共感的", "育む", "愛"], description: "あなたのオーラは優しく癒すエネルギーで輝いています。深い共感の稀な才能を持ち、他者が本当に見られ、ケアされていると感じさせます. あなたの存在自体が癒しの形です。", strengths: ["深い感情的知性と共感能力", "慰め癒す生まれつきの能力", "脆弱性のための安全な空間を創造"], recommendations: ["援助職業やボランティア活動を追求", "他者をケアしながら健康的な境界を設定", "真剣にセルフケアを実践"] },
            midnightBlack: { name: "ミッドナイトブラック", subtitle: "深い哲学者", keywords: ["内省的", "賢明", "深遠"], description: "あなたのオーラは真夜中の深さを持ち、そこから最も偉大な洞察が生まれます。表面を超えた意味を求め、瞑想的な性質は他者が見逃す真実を明らかにします。", strengths: ["深遠な哲学的で分析的思考", "他者が見逃すつながりを見る", "深い内省から来る知恵"], recommendations: ["執筆や教育を通じて洞察を共有", "孤独と深い思考のための時間を作る", "哲学, 心理学, またはスピリチュアリティを探求"] }
        },
    ...
    es: {
        ...
        questions: [
            ...
            { q: "Tu entorno de trabajo ideal:", a: ["Estructurado con objetivos claros", "Colaborativo y de apoyo", "Dinámico y de ritmo rápido", "Tranquilo y enfocado"] },
