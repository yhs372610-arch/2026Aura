// 다국어 번역 데이터 - SEO 항목 누락 수정 및 최종 통합 버전
const translations = {
    ko: {
        ...
        seo: { learnMore: "✨ 2026 오라 컬러 테스트 상세 가이드", title: "2026 오라 컬러 테스트: 당신의 잠재된 에너지를 발견하는 여행", description: "2026년은 그 어느 때보다 개인의 고유한 에너지와 내면의 평화가 중요해지는 시기입니다. 2026 오라 컬러 테스트는 최신 색채 심리학과 성격 분석 알고리즘을 결합하여, 사용자가 현재 발산하고 있는 고유의 주파수를 색상으로 시각화해 줍니다.", item1: "<strong>2026 트렌딩:</strong> 2026년 당신의 에너지와 공명하는 컬러를 발견하세요.", item2: "<strong>개인별 인사이트:</strong> 아우라 분석을 통해 실질적인 조언을 제공합니다.", item3: "<strong>최신 알고리즘:</strong> 2026년의 사회적, 심리학적 트렌드를 반영했습니다." }
    },
    en: {
        ...
        seo: { learnMore: "✨ Detailed Guide to 2026 Aura Color Test", title: "2026 Aura Color Test: A Journey to Discover Your Latent Energy", description: "2026 is a year where individual uniqueness and inner peace are more important than ever. The 2026 Aura Color Test combines the latest color psychology with personality analysis algorithms to visualize the unique frequency you emit as a color.", item1: "<strong>2026 Trending:</strong> Discover the color that resonates with your energy in 2026.", item2: "<strong>Personal Insights:</strong> Get actionable advice based on your aura analysis.", item3: "<strong>Latest Algorithm:</strong> Reflecting the social and psychological trends of 2026." }
    },
    ja: {
        ...
        colors: {
            coolBlue: { name: "クールブルー", subtitle: "冷静な戦略家", keywords: ["戦略적", "冷静", "信頼"], description: "あなたのオーラは冷静で整ったエネルギーを放っています。論理と明確さを持って人生にアプローチし、生まれながらの問題解決者の役割を果たします。", strengths: ["綿密な戦略立案と分析能力", "プレッシャーの中でも沈着冷静", "混乱の中で秩序を創造する"], recommendations: ["計画が必要なプロジェクトを主導してください", "文章を通じて自分の洞察を共有してください", "論理と創造的な探求のバランスをとってください"] },
            vampPurple: { name: "ヴァンプパープル", subtitle: "神秘的な創造者", keywords: ["神秘的", "創造的", "強烈"], description: "あなたのオーラは魅惑的で神秘的なエネルギーを秘めています。暗闇の中に美しさを見出し、複雑さの中に深みを見つけます。", strengths: ["深い創造的ビジョンと芸術적才能", "複雑な状況での柔軟性", "他人の好奇心を刺激する魅力的な存在感"], recommendations: ["あなた独自の創造的なスタイルを受け入れてください", "自分の芸術を世の中に堂々と発信してください", "劇的な美学を探求してみてください"] },
        ...
        seo: { learnMore: "✨ 診断の詳細ガイド", title: "2026年オーラカラー診断：あなたのエネルギーを発見する旅", description: "心理学に基づいた最新のアルゴリズムで、あなたの2026年のエネルギーを診断します。", item1: "<strong>2026トレンド:</strong> 2026年のあなたのエネルギーと共鳴するカラーを発見してください。", item2: "<strong>個人別インサイト:</strong> オーラ分析を通じて実質的な助言を提供します。", item3: "<strong>最新アルゴリズム:</strong> 2026年の社会的、心理学的なトレンドを反映しました。" }
    },
    es: {
        ...
        seo: { learnMore: "✨ Guía detallada", title: "Test de Aura 2026: Tu energía interior", description: "Descubre tu color de energía basado en psicología para el 2026.", item1: "<strong>Tendencias 2026:</strong> Descubre el color que resuena con tu energía en 2026.", item2: "<strong>Perspectivas personales:</strong> Obtén consejos prácticos basados en tu aura.", item3: "<strong>Algoritmo actualizado:</strong> Refleja las tendencias sociales y psicológicas de 2026." }
    },
    pt: {
        ...
        seo: { learnMore: "✨ Guia de Aura", title: "Teste de Aura 2026: Sua energia interior", description: "Descubra sua cor de energia para 2026 com base na psicologia.", item1: "<strong>Tendências 2026:</strong> Descubra a cor que ressoa com sua energia em 2026.", item2: "<strong>Insights pessoais:</strong> Receba conselhos práticos com base na sua aura.", item3: "<strong>Algoritmo atualizado:</strong> Reflete as tendências sociais e psicológicas de 2026." }
    }
};
